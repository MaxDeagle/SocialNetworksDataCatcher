...
namespace VKForms
{
    class VKRequests
    {
       ...
       public static string getUserInfo(string user_domain)
       {
           ...
           string request_string = "https://api.vk.com/method/users.get?user_ids=" + user_domain + "&fields=" + fieldsLine + "&v=5.633";
           ...
           while (true)
           {
               ...
               {
                   if (reqCount <= 5)
                       Console.WriteLine("having problems, next try...");
                   else
                   {
        ...
        public static string getWall(string proxy_string, string target_domain, int offset)
        {
            int reqCount = 0; //how many attempts
            string result = "";
            string request_string = "https://api.vk.com/api.php?oauth=1&method=wall.get&domain=" + target_domain + "&offset=" + offset + "&count=50&filter=all&extended=1&v=5.63";
        ...
        public static string getSizeOfWall(string target_domain)
        {
            int reqCount = 0; //how many attempts
            string result = "";
            string request_string = "https://api.vk.com/api.php?oauth=1&method=wall.get&domain=" + target_domain + "&count=1&filter=all&extended=1&v=5.63";
            while (true)
            {
                try
                {
